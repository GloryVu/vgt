...
def main(args):
    ...
    register_coco_instances(
        "doclayent_train",
        {},
        "./dataset/DocLayNet_9k/COCO/test.json",
        "./dataset/DocLayNet_9k/PNG"
    )
    ...
    if args.eval_only:
        ...
        for ckpt in [file for file in os.listdir('./output_9k') if '.pth' in file]:
            # cfg.MODEL.WEIGHTS = f'./output3/{ckpt}'
            ...
            with open('./eval_9k/'+ckpt.replace('.pth','.json'),'w') as f:
